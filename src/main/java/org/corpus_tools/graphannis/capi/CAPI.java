...
public class CAPI implements Library {
  ...
  public static native AnnisComponentConst annis_vec_component_get(AnnisVec_AnnisComponent ptr,
      NativeLong i);
  ...
  public static native String annis_matrix_str_get(AnnisMatrix_AnnisCString ptr, NativeLong row,
      NativeLong col);
  ...
  public static native NativeLong annis_freqtable_str_count(AnnisFrequencyTable_AnnisCString ptr,
      NativeLong row);

  public static native String annis_freqtable_str_get(AnnisFrequencyTable_AnnisCString ptr,
      NativeLong row, NativeLong col);
  ...
  public static native NativeLong annis_vec_qattdesc_get_component_nr(QueryAttributeDescription ptr,
      NativeLong i);

  public static native CharPointer annis_vec_qattdesc_get_aql_fragment(
      QueryAttributeDescription ptr, NativeLong i);

  public static native CharPointer annis_vec_qattdesc_get_variable(QueryAttributeDescription ptr,
      NativeLong i);

  public static native CharPointer annis_vec_qattdesc_get_anno_name(QueryAttributeDescription ptr,
      NativeLong i);

  // corpus storage class

  public static native AnnisCorpusStorage annis_cs_with_auto_cache_size(String db_dir,
      boolean use_parallel_joins, AnnisErrorListRef err);

  public static native AnnisCorpusStorage annis_cs_with_max_cache_size(String db_dir,
      long max_cache_size, boolean use_parallel_joins, AnnisErrorListRef err);
  ...
  public static native long annis_cs_count(AnnisCorpusStorage cs, AnnisVec_AnnisCString corpusNames,
  ...
  public static native AnnisVec_AnnisCString annis_cs_find(AnnisCorpusStorage cs,
      AnnisVec_AnnisCString corpusNames, String query, int query_language, long offset,
      LongByReference limit, int order, AnnisErrorListRef err);
  ...
  public static native AnnisGraph annis_cs_subgraph(AnnisCorpusStorage cs, String corpusName,
      ...
      String segmentation, AnnisErrorListRef err);
  ...
  public static native AnnisGraph annis_cs_subgraph_for_query(AnnisCorpusStorage cs,
      String corpusName, String query, int queryLanguage, AnnisErrorListRef err);

  public static native AnnisGraph annis_cs_subgraph_for_query_with_ctype(AnnisCorpusStorage cs,
      String corpusName, String query, int queryLanguage, int ctype, AnnisErrorListRef err);

  public static native AnnisFrequencyTable_AnnisCString annis_cs_frequency(AnnisCorpusStorage cs,
      AnnisVec_AnnisCString corpusNames, String query, int queryLanguage,
      String frequencyQueryDefinition, AnnisErrorListRef err);

  public static native AnnisVec_AnnisComponent annis_cs_list_components_by_type(
      AnnisCorpusStorage cs, String corpusName, int ctype, AnnisErrorListRef err);

  public static native AnnisMatrix_AnnisCString annis_cs_list_node_annotations(
      AnnisCorpusStorage cs, String corpusName, boolean listValues, boolean onlyMostFrequentValues,
      AnnisErrorListRef err);

  public static native AnnisMatrix_AnnisCString annis_cs_list_edge_annotations(
      AnnisCorpusStorage cs, String corpusName, int component_type, String component_name,
  ...
  public static native boolean annis_cs_validate_query(AnnisCorpusStorage cs,
      AnnisVec_AnnisCString corpusNames, String query, int queryLanguage, AnnisErrorListRef err);

  public static native QueryAttributeDescription annis_cs_node_descriptions(AnnisCorpusStorage cs,
      String query, int queryLanguage, AnnisErrorListRef err);

  public static native boolean annis_cs_delete(AnnisCorpusStorage cs, String corpusName,
      AnnisErrorListRef err);

  public static native void annis_cs_unload(AnnisCorpusStorage cs, String corpusName,
      AnnisErrorListRef err);
  ...
  public static native void annis_graphupdate_add_node(AnnisGraphUpdate ptr, String node_name,
      String node_type, AnnisErrorListRef err);
  ...
  public static native void annis_graphupdate_add_node_label(AnnisGraphUpdate ptr, String node_name,
      String anno_ns, String anno_name, String anno_value, AnnisErrorListRef err);

  public static native void annis_graphupdate_delete_node_label(AnnisGraphUpdate ptr,
      String node_name, String anno_ns, String anno_name, AnnisErrorListRef err);
  ...
  public static native void annis_graphupdate_delete_edge_label(AnnisGraphUpdate ptr,
      String source_node, String target_node, String layer, String component_type,
      String component_name, String anno_ns, String anno_name, AnnisErrorListRef err);
  ...
  public static native AnnisIterPtr_AnnisNodeID annis_graph_nodes_by_type(AnnisGraph g,
      String node_type);

  public static native AnnisVec_AnnisComponent annis_graph_all_components(AnnisGraph g);

  public static native AnnisVec_AnnisComponent annis_graph_all_components_by_type(AnnisGraph g,
      int ctype);
  ...
  public static native AnnisVec_AnnisAnnotation annis_graph_annotations_for_edge(AnnisGraph g,
      AnnisEdge.ByValue edge, AnnisComponentConst component, AnnisErrorListRef err);
}
